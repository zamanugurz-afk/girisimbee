...
import { ArrowLeft, ArrowRight, Briefcase, CheckCircle2, UserRoundSearch } from 'lucide-react';
    ...
    <section aria-labelledby="create-career-heading">
      ...
      <div className="grid gap-4 lg:grid-cols-2 lg:gap-5">
        {CREATE_LISTING_CAREER_COPY.options.map((option) => {
          const landing = CAREER_FLOW_OPTIONS.find((item) => item.id === option.id);
          ...
          return (
            ...
            >
              ...
              <h3 className="mt-5 font-display text-xl font-bold tracking-tight text-[#0B1220] dark:text-foreground sm:text-[22px]">
                {landing.label}
              </h3>
