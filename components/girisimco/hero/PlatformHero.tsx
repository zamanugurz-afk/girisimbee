...
export const HERO_SLIDES: HeroSlide[] = [
  ...
  },
  {
    ...
    titleSuffix: ' Hesapla.',
    description: '33 sektörde m², kira peşinatı, kilitli yasal zorunluluklar, demirbaşlar, açılış emtiası ve ERP lisans maliyetlerini saniyeler içinde simüle et.',
  ...
  },
  {
    ...
    titleSuffix: ' Keşfet.',
    description: '33 sektörde NACE kodunuza özel KOSGEB hibe paketleri, Genç Girişimci vergi muafiyeti ve bölgesel SGK teşviklerini anlık hesaplayın.',
