                      ...
                      >
                        <div className="space-y-1.5">
                          <div className="flex items-center justify-between">
                            <span className="text-2xl sm:text-3xl">{sec.emoji}</span>
                        ...
                        <div className="pt-2 border-t border-slate-100 dark:border-zinc-800 flex items-center justify-between">
                          <span className="text-[11px] sm:text-xs text-emerald-700 dark:text-emerald-400 font-extrabold">
                            {formatCurrency(maxHibe)} Hibe
                          </span>
                          <span
                            className={cn(
                              'w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold transition-colors',
                              isSelected ? 'bg-emerald-600 text-white' : 'bg-slate-100 dark:bg-zinc-800 text-slate-400',
                            )}
                          >
                            ✓
                          </span>
