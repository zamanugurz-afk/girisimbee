            ...
            {HOME_CATEGORIES.map((cat, index) => {
              ...
              <ScrollReveal key={cat.slug} delay={Math.min(index * 30, 90)}>
                ...
                >
                  ...
                  <span className="relative mt-2 inline-flex items-center gap-1 text-gc-xs font-medium opacity-0 transition-all duration-300 group-hover:opacity-100 sm:text-gc-sm" style={{ color: cat.color }}>
                    Keşfet
