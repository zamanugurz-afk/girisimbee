        ...
        <div className="relative overflow-hidden rounded-[2.25rem] bg-white/90 dark:bg-zinc-900/90 border border-slate-200/80 dark:border-zinc-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] p-6 sm:p-10 lg:p-14">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center">
              ...
              <h3 className="font-sans text-base sm:text-lg lg:text-xl font-bold tracking-tight text-slate-900 dark:text-zinc-100 leading-snug">
                Seçili fırsat, stratejik ortaklık ve büyüme işbirlikleri
              </h3>

              {/* Josefin Sans Gövde Metinleri */}
              <div className="mt-3.5 space-y-2.5 text-sm sm:text-[15px] leading-relaxed text-slate-600 dark:text-zinc-400 font-normal">
                <p>
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3 pt-4 border-t border-slate-100 dark:border-zinc-800/80">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-bold text-xs px-5 py-2.5 shadow-sm shadow-amber-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
                ...
                <Link
                  href="/ilan/olustur"
                  className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-4 py-2.5 text-xs font-semibold text-slate-800 dark:text-zinc-200 hover:bg-slate-50 dark:hover:bg-zinc-700 hover:border-slate-300 transition-all"
                >
