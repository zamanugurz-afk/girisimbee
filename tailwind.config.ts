  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fade-in-up': 'fade-in-up 0.12s cubic-bezier(0.22,1,0.36,1) both',
        'fade-in-down': 'fade-in-down 0.12s cubic-bezier(0.22,1,0.36,1) both',
        'scale-in': 'scale-in 0.12s cubic-bezier(0.34,1.56,0.64,1) both',
        shimmer: 'shimmer 1.6s infinite',
        'pulse-soft': 'pulse-soft 2s ease-in-out infinite',
        'slide-in-right': 'slide-in-right 0.12s cubic-bezier(0.22,1,0.36,1) both',
        'reveal-up': 'reveal-up 0.12s cubic-bezier(0.22,1,0.36,1) both',
      },
    },
  },
