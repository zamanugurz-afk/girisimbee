...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'gc-xs': ['0.75rem', { lineHeight: '1.125rem' }],
        'gc-sm': ['0.875rem', { lineHeight: '1.375rem' }],
        'gc-base': ['0.95rem', { lineHeight: '1.45rem' }],
        'gc-md': ['1.05rem', { lineHeight: '1.6rem', letterSpacing: '-0.01em' }],
        'gc-lg': ['1.2rem', { lineHeight: '1.8rem', letterSpacing: '-0.02em' }],
        'gc-xl': ['1.6rem', { lineHeight: '2.1rem', letterSpacing: '-0.025em' }],
        'gc-2xl': ['1.9rem', { lineHeight: '2.4rem', letterSpacing: '-0.03em' }],
        'gc-3xl': ['2.25rem', { lineHeight: '2.75rem', letterSpacing: '-0.035em' }],
      },
      backgroundImage: {
