...
export function extractFranchiseOpportunityProfile(listing: Listing): FranchiseOpportunityProfile {
  ...
  return {
    ...
    franchiseModel: normalizeText(cf.franchiseModel) || normalizeText(cf.businessCategory),
    businessCategory: normalizeText(cf.businessCategory) || normalizeText(cf.franchiseModel),
    totalInvestment,
    ...
    storeLocationType: normalizeText(cf.storeLocationType),
    ...
    exclusiveTerritory: typeof cf.exclusiveTerritory === 'boolean' ? cf.exclusiveTerritory : null,
    trademarkStatus: normalizeText(cf.trademarkStatus),
    contractProvided: normalizeText(cf.contractProvided),
    operatingManualProvided: normalizeText(cf.operatingManualProvided),
