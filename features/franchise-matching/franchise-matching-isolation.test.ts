...
describe('Franchise Matching Isolation', () => {
  it('preserves career matching weights untouched', () => {
  ...
  it('preserves digital & AI solution matching weights untouched', () => {
  ...
  it('has independent franchise matching weights totalling 100%', () => {
