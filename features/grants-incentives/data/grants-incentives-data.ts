...
> = {
  ...
  'bubble-tea-bar': {"name":"Bubble Tea & Özel İçecek Barı","emoji":"🧋","category":"Yeme - İçme","nace":"56.30.02","desc":"Çay, Kahve, Meyve Suyu ve İçecek Sunan Mekanların Faaliyetleri"},
  'butik-burger': {"name":"Butik Burger & Sokak Lezzetleri","emoji":"🍔","category":"Yeme - İçme","nace":"56.10.08","desc":"Fast-Food, Burger ve Hızlı Yiyecek Hazırlama ve Satış Faaliyetleri"},
  'dondurma-gelato': {"name":"Artisan Dondurmacı & Gelato Barı","emoji":"🍨","category":"Yeme - İçme","nace":"56.10.05","desc":"Dondurma ve Diğer Soğuk Tatlıların İmalatı ve Satışı"},
  'kahvalti-borek-salonu': {"name":"Kahvaltı & Serpme Börek Salonu","emoji":"🍳","category":"Yeme - İçme","nace":"56.10.01","desc":"Geleneksel Kahvaltı ve Sıcak Yemek Restoran Hizmetleri"},
  'corbaci-paca': {"name":"Tarihi Gece Çorbacısı & Paça Salonu","emoji":"🥣","category":"Yeme - İçme","nace":"56.10.01","desc":"Geleneksel Çorba, Paça ve Gece Lokantacılığı Faaliyetleri"},
  'guzellik-lazer-merkezi': {"name":"Güzellik & Lazer Epilasyon Merkezi","emoji":"💄","category":"Kişisel Bakım & Sağlık","nace":"96.02.03","desc":"Güzellik Salonlarının Faaliyetleri (Cilt bakımı, epilasyon, masaj)"},
  'nail-art-protez-tirnak': {"name":"Nail Art & Protez Tırnak Stüdyosu","emoji":"💅","category":"Kişisel Bakım & Sağlık","nace":"96.02.04","desc":"Manikür, Pedikür ve Tırnak Tasarım Hizmetleri"},
  'diyetisyen-beslenme-klinigi': {"name":"Diyetisyen & Beslenme Danışmanlığı","emoji":"🥗","category":"Kişisel Bakım & Sağlık","nace":"86.90.17","desc":"Tıp Dışı Sağlık Danışmanlığı (Diyetisyen ve Beslenme Uzmanları)"},
  'yeni-nesil-berber': {"name":"Yeni Nesil Berber & Erkek Bakım Salonu","emoji":"💈","category":"Kişisel Bakım & Sağlık","nace":"96.02.01","desc":"Erkek Berberliği ve Saç Kesim Faaliyetleri"},
  'nalbur-yapi-market': {"name":"Nalbur & Yapı Hırdavat Marketi","emoji":"🔨","category":"Perakende & Zanaat","nace":"47.52.01","desc":"Hırdavat, Boya, Tesisat ve Cam Mallarının Perakende Ticareti"},
  'kuyumcu-sarraf': {"name":"Kuyumcu & Sarrafiye Mağazası","emoji":"💍","category":"Perakende & Zanaat","nace":"47.77.01","desc":"Altın ve Mücevher Perakende Ticareti"},
  'zuccaciye-ev-esyalari': {"name":"Züccaciye & Ev Eşyaları Mağazası","emoji":"🍽️","category":"Perakende & Zanaat","nace":"47.59.02","desc":"Çatal Bıçak Takımı, Mutfak Eşyası ve Porselen Perakende Ticareti"},
  'dijital-baski-matbaa': {"name":"Dijital Baskı & Matbaa Merkezi","emoji":"🖨️","category":"Perakende & Zanaat","nace":"18.12.01","desc":"Diğer Matbaacılık Faaliyetleri (Dijital, ofset, tabela)","isAdvanced":true},
  'dil-okulu-kurs': {"name":"Yabancı Dil Kursu & Sınav Hazırlık","emoji":"📚","category":"Finans & Hizmet","nace":"85.59.03","desc":"Dil ve Konuşma Becerileri Eğitimi Veren Özel Kurslar"},
  'turizm-seyahat-acentesi': {"name":"Turizm & Seyahat Acentesi (TÜRSAB)","emoji":"✈️","category":"Finans & Hizmet","nace":"79.11.01","desc":"Seyahat Acentesi Faaliyetleri (Ulaşım, konaklama, tur)"},
  'parti-cocuk-oyun-evi': {"name":"Çocuk Oyun Evi & Doğum Günü Atölyesi","emoji":"🎈","category":"Finans & Hizmet","nace":"93.29.02","desc":"Çocuk Oyun Alanları, Softplay ve Eğlence Parkı Faaliyetleri"},
  'oto-kiralama-rentacar': {"name":"Oto Kiralama & Rent A Car Ofisi","emoji":"🚘","category":"Finans & Hizmet","nace":"77.11.01","desc":"Motorlu Kara Taşıtlarının Sürücüsüz Olarak Kiralanması"},
  'oto-yedek-parca': {"name":"Oto Yedek Parça & Akü Satış","emoji":"⚙️","category":"Perakende & Zanaat","nace":"45.32.02","desc":"Motorlu Kara Taşıtlarının Parça ve Aksesuarlarının Perakende Ticareti"},
  'dijital-pazarlama-ajansi': {"name":"Dijital Pazarlama & Sosyal Medya Ajansı","emoji":"📢","category":"Finans & Hizmet","nace":"73.11.01","desc":"Reklam Ajanslarının Faaliyetleri (Dijital medya, SEO)","isAdvanced":true},
  'mobilya-dekorasyon': {"name":"Butik Mobilya & Ev Dekorasyonu","emoji":"🛋️","category":"Perakende & Zanaat","nace":"47.59.01","desc":"Ev Mobilyalarının Perakende Ticareti"},
  'cilingir-anahtar': {"name":"Çilingir & Güvenlik Kilit Atölyesi","emoji":"🔑","category":"Perakende & Zanaat","nace":"95.29.03","desc":"Kilit ve Anahtar Tamiri, Çilingirlik Hizmetleri"},
  'oto-tamir-mekanik': {"name":"Oto Tamir & Mekanik Bakım Servisi","emoji":"🔧","category":"Otomotiv & Sanayi","nace":"45.20.01","desc":"Motorlu Kara Taşıtlarının Genel Bakım ve Onarım Hizmetleri","isAdvanced":true},
};
