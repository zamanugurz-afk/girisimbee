...
export function normalizeCareerExperience(row: CareerExperience): CareerExperience {
  ...
  return {
    ...
    role,
    roleOther: (row.roleOther ?? '').trim(),
    company: (row.company ?? '').trim(),
    duration,
    responsibilities,
    achievements,
    responsibilitiesOther: (row.responsibilitiesOther ?? '').trim(),
    achievementsOther: (row.achievementsOther ?? '').trim(),
  ...
  return value
    .map((row) => {
      ...
      const parsed: CareerExperience = {
        ...
        roleOther: String(r.roleOther ?? '').trim(),
        company: String(r.company ?? r.companyName ?? r.employer ?? '').trim(),
        ...
        selectedResponsibilities,
        responsibilitiesOther: String(r.responsibilitiesOther ?? '').trim(),
        responsibilities: String(r.responsibilities ?? '').trim(),
        selectedAchievements,
        achievementsOther: String(r.achievementsOther ?? '').trim(),
        achievementMetric: String(r.achievementMetric ?? '').trim(),
