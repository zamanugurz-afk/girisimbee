...
const SECTOR_METAS: Record<string, SectorMeta> = {
  ...
  'bubble-tea-bar': {
    ...
    "institution3": "İl/İlçe Tarım ve Orman Müdürlüğü",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Gıda İşletme Kayıt Belgesi & Hijyen Onayı",
    "step3ProTip": "Otomatik bardak kapatma makinesi, su arıtma sistemi ve bubble tea şurupları için gıda tescili gerekir.",
    "step5ProTip": "İlçe belediyesinden sıhhi müessese açılış ruhsatı alınır."
},
  'butik-burger': {
    ...
    "cost": 52000,
    "days": "10 - 15 İş Günü",
    "institution3": "İtfaiye & İlçe Tarım Müdürlüğü",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Elektrostatik Filtre, Ağır Baca & Gıda Üretim İzni",
    "step3ProTip": "Izgara dumanı için elektrostatik baca filtresi ve itfaiye K tipi otomatik söndürme şarttır.",
    "step5ProTip": "Belediyeden 1. sınıf lokanta çalışma ruhsatı teslim alınır."
},
  'dondurma-gelato': {
    ...
    "cost": 37500,
    "days": "7 - 10 İş Günü",
    "institution3": "İlçe Tarım ve Orman Müdürlüğü",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Sütlü Tatlı ve Dondurma İmalat/Satış Onayı",
    "step3ProTip": "Pastörizatör, şok dondurucu ve hijyen belgeleri dosyaya eklenir.",
    "step5ProTip": "Belediye sıhhi işyeri açılış ruhsatı verilir."
},
  'kahvalti-borek-salonu': {
    ...
    "cost": 46000,
    "days": "8 - 12 İş Günü",
    "institution3": "İlçe Tarım Müdürlüğü & Lokantacılar Odası",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Sıcak Yemek Sunum ve Hijyen Tescili",
    "step3ProTip": "Çay kazanı basınç testi, börek ısıtma tezgahı ve personel hijyen belgeleri denetlenir.",
    "step5ProTip": "Belediye lokanta ruhsatı teslim edilir."
},
  'corbaci-paca': {
    ...
    "cost": 54000,
    "days": "10 - 14 İş Günü",
    "institution3": "İlçe Belediyesi & Emniyet Müdürlüğü",
    "channel3": "Fiziki Başvuru",
    "step3Title": "24 Saat Gece Çalışma ve Sıcak Yemek İzni",
    "step3ProTip": "Gece açık kalma izin harcı ve sürekli çalışan kazanlar için itfaiye baca raporu gerekir.",
    "step5ProTip": "24 saat açık lokanta çalışma ruhsatı verilir."
},
  'guzellik-lazer-merkezi': {
    ...
    "cost": 50500,
    "days": "10 - 15 İş Günü",
    "institution3": "İl Sağlık Müdürlüğü & Kuaförler/Güzellik Odası",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Güzellik Salonu Uygunluk ve Usta Öğretici Tescili",
    "step3ProTip": "Lazer epilasyon odalarında mekanik havalandırma, B sınıfı otoklav ve mesul müdür ustalık belgesi aranır.",
    "step5ProTip": "Belediye ve sağlık müdürlüğü ortak komisyonu sonrası ruhsat düzenlenir."
},
  'nail-art-protez-tirnak': {
    ...
    "cost": 32500,
    "days": "5 - 7 İş Günü",
    "institution3": "Esnaf ve Sanatkarlar Odası",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Manikür/Pedikür Ustalık ve Hijyen Belgesi",
    "step3ProTip": "Toz emişli tırnak masaları ve kuru hava alet sterilizatörü kontrol edilir.",
    "step5ProTip": "Belediye güzellik hizmeti açılış ruhsatı alınır."
},
  'diyetisyen-beslenme-klinigi': {
    ...
    "cost": 46000,
    "days": "7 - 10 İş Günü",
    "institution3": "T.C. Sağlık Bakanlığı / İl Sağlık Müdürlüğü",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Diyetisyenlik Meslek Tescili ve Merkez Onayı",
    "step3ProTip": "Beslenme ve Diyetetik lisans diploması, oda kaydı ve segmental analiz cihazı kalibrasyon belgeleri sunulur.",
    "step5ProTip": "İl Sağlık uygunluk belgesi ile belediye ofis ruhsatı verir."
},
  'yeni-nesil-berber': {
    ...
    "cost": 34500,
    "days": "5 - 7 İş Günü",
    "institution3": "Berberler Esnaf Odası",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Erkek Berberliği Ustalık Tescili ve Hijyen Belgesi",
    "step3ProTip": "UV alet sterilizatörü, tek kullanımlık havlular ve ustalık belgesi ibraz edilir.",
    "step5ProTip": "Belediye sıhhi işyeri ruhsatı teslim alınır."
},
  'nalbur-yapi-market': {
    ...
    "cost": 46000,
    "days": "7 - 10 İş Günü",
    "institution3": "İlçe İtfaiye Müdürlüğü",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Yanıcı Madde (Tiner/Boya) Yangın Güvenlik Raporu",
    "step3ProTip": "Boya ve tiner reyonları için köpüklü yangın tüpü ve havalandırma şarttır.",
    "step5ProTip": "Belediye hırdavat perakende ruhsatı verir."
},
  'kuyumcu-sarraf': {
    ...
    "cost": 136000,
    "days": "15 - 20 İş Günü",
    "institution3": "Ticaret Bakanlığı & MASAK & Kuyumcular Odası",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Kuyum Ticareti Yetki Belgesi & MASAK Uyum Onayı",
    "step3ProTip": "Kurşun geçirmez vitrin camı, 2.5 ton kademeli çelik kasa, 4K CCTV ve polis panik butonu entegrasyonu zorunludur.",
    "step5ProTip": "1. Sınıf yüksek güvenlikli kuyumcu belediye ruhsatı düzenlenir."
},
  'zuccaciye-ev-esyalari': {
    ...
    "cost": 39500,
    "days": "5 - 7 İş Günü",
    "institution3": "Ticaret Odası / Esnaf Odası",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Züccaciye & Mutfak Eşyaları Faaliyet Kaydı",
    "step3ProTip": "Kırılmaz ambalajlama alanı ve yangın tüpü uygunluğu sağlanır.",
    "step5ProTip": "Belediye gayrisıhhi olmayan perakende ruhsatı teslim eder."
},
  'dijital-baski-matbaa': {
    ...
    "cost": 40500,
    "days": "7 - 10 İş Günü",
    "institution3": "Matbaacılar Odası & İtfaiye",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Matbaa Basım İzin Belgesi & Kağıt Depolama Raporu",
    "step3ProTip": "Giyotin kağıt kesme makinesi iş güvenliği sensörleri ve solvent havalandırması denetlenir.",
    "step5ProTip": "Belediye matbaacılık ve reklam üretim ruhsatı verir."
},
  'dil-okulu-kurs': {
    ...
    "cost": 91000,
    "days": "20 - 30 İş Günü",
    "institution3": "Milli Eğitim Bakanlığı (MEB) Özel Öğretim Kurumları",
    "channel3": "Fiziki Başvuru",
    "step3Title": "MEB Kurum Açma İzni & Maarif Müfettişi Raporu",
    "step3ProTip": "Derslik tavan yüksekliği, yangın merdiveni, ses yalıtımı ve öğretmen kadrosu şartları aranır.",
    "step5ProTip": "MEB onaylı özel öğretim kurumu çalışma ruhsatı verilir."
},
  'turizm-seyahat-acentesi': {
    ...
    "cost": 224000,
    "days": "15 - 25 İş Günü",
    "institution3": "Kültür ve Turizm Bakanlığı & TÜRSAB",
    "channel3": "Fiziki Başvuru",
    "step3Title": "A Grubu Seyahat Acentası Belgesi & Banka Teminatı",
    "step3ProTip": "Bakanlığa resmi teminat mektubu yatırılır ve TÜRSAB levha kaydı tamamlanır.",
    "step5ProTip": "Turizm Bakanlığı onaylı seyahat acentesi çalışma ruhsatı verilir."
},
  'parti-cocuk-oyun-evi': {
    ...
    "cost": 50000,
    "days": "10 - 15 İş Günü",
    "institution3": "İlçe Belediyesi & TSE Denetim Heyeti",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Softplay TSE EN 1176 Güvenlik & Çocuk Alanı Sertifikasyonu",
    "step3ProTip": "Darbe emici zemin, softplay file güvenlikleri ve çocuk gelişimi personeli aranır.",
    "step5ProTip": "Eğlence ve oyun alanı belediye ruhsatı düzenlenir."
},
  'oto-kiralama-rentacar': {
    ...
    "cost": 99000,
    "days": "10 - 14 İş Günü",
    "institution3": "İl Emniyet Müdürlüğü (KABİS) & Ticaret İl Müdürlüğü",
    "channel3": "Fiziki Başvuru",
    "step3Title": "KABİS Bildirim Sistemi Entegrasyonu & Yetki Belgesi",
    "step3ProTip": "Emniyet Genel Müdürlüğü KABİS şifresi alınır ve filo kasko poliçeleri ibraz edilir.",
    "step5ProTip": "Belediye oto kiralama ofis ruhsatı verir."
},
  'oto-yedek-parca': {
    ...
    "cost": 40500,
    "days": "5 - 7 İş Günü",
    "institution3": "Ticaret Odası & İtfaiye",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Yedek Parça ve Akü Depolama Yangın Güvenlik Onayı",
    "step3ProTip": "Akü asidi ve madeni yağ depolama yangın önlemleri kontrol edilir.",
    "step5ProTip": "Belediye yedek parça satış ruhsatı teslim eder."
},
  'dijital-pazarlama-ajansi': {
    ...
    "cost": 42000,
    "days": "3 - 5 İş Günü",
    "institution3": "Ticaret Odası & Bilişim İhracatçıları Birliği",
    "channel3": "Online Portal",
    "step3Title": "Hizmet İhracatı ve Dijital Ajans Tescili",
    "step3ProTip": "Yazılım ve dijital reklam faaliyetleri MERSİS ana sözleşmesine eklenir.",
    "step5ProTip": "Belediye büro ve ofis çalışma ruhsatı verilir."
},
  'mobilya-dekorasyon': {
    ...
    "institution3": "Ticaret Odası & İtfaiye",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Mobilya Showroom Yangın ve Alan Uygunluk Onayı",
    "step3ProTip": "Ahşap teşhir alanları için yangın dolapları ve acil çıkışlar kontrol edilir.",
    "step5ProTip": "Belediye mobilya mağazası çalışma ruhsatı verir."
},
  'cilingir-anahtar': {
    ...
    "cost": 38000,
    "days": "7 - 10 İş Günü",
    "institution3": "İl Emniyet Müdürlüğü & Çilingirler Odası",
    "channel3": "Fiziki Başvuru",
    "step3Title": "Emniyet Güvenlik Soruşturması ve Çilingir Tescili",
    "step3ProTip": "Adli sicil kaydı, ustalık belgesi ve emniyet onay yazısı şarttır.",
    "step5ProTip": "Belediye güvenlik kilit ve çilingir ruhsatı verir."
},
  'oto-tamir-mekanik': {
    ...
    "cost": 54000,
    "days": "10 - 15 İş Günü",
    "institution3": "Sanayi İl Müdürlüğü & Esnaf Odası & İtfaiye",
    "channel3": "Fiziki Başvuru",
    "step3Title": "TSE 12047 Standart Uygunluğu & Atık Yağ Bertaraf İzni",
    "step3ProTip": "Araç lifti periyodik muayene raporu, atık motor yağı depolama tankı ve çevre izni aranır.",
    "step5ProTip": "Sanayi sitesi gayrisıhhi müessese çalışma ruhsatı teslim alınır."
},
};
