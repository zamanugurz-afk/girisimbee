...
export const BUSINESS_TEMPLATES: Record<string, BusinessTemplate> = {
  ...
  'sigorta-acentesi': {
    ...
    mandatoryLegalItems: [
      ...
      { name: 'Limited Şirket Kuruluşu & Sicil Gazetesi', cost: 42000, description: 'Ticaret Sicil Gazetesi ilanı ve noter tasdikleri' },
      { name: 'Mesleki Sorumluluk Sigortası (Yıllık)', cost: 30000, description: 'SEDDK zorunlu mesleki teminat poliçesi' },
      { name: 'Belediye İşyeri Açma ve Çalışma Ruhsatı', cost: 12000, description: 'İlçe belediyesi ticari müessese harcı' },
      { name: 'İtfaiye Yangın & Tahliye Uygunluk Raporu', cost: 5500, description: 'Yangın güvenliği onay belgesi' }
    ],
    equipments: [
    ...
    softwareLicenseCost: { annual: 28000, monthlyMaintenance: 2200, name: 'Sigorta Acente Ekranları & Çoklu Teklif ERP Lisansı (Polisoft/Acente24)' },
    recommendedStaff: [
      { role: 'Teknik Müdür (4 Yıl Lisans + SEGEM + 2 Yıl Deneyim)', count: 1, avgSalary: 55000, isMandatory: true, allowOwnerFulfillment: true },
  ...
  'emlak-gayrimenkul': {
    ...
    mandatoryLegalItems: [
      ...
      { name: 'Şirket Kuruluş & Vergi Levhası Onayları', cost: 18000, description: 'Ticaret sicil ilanları' }
    ],
    equipments: [
    ...
    softwareLicenseCost: { annual: 22000, monthlyMaintenance: 1600, name: 'Emlak Portalları Entegre CRM & Sözleşme Yönetim Paketi' },
    recommendedStaff: [
      { role: 'Sorumlu Emlak Danışmanı (Seviye 5 MYK)', count: 1, avgSalary: 45000, isMandatory: true, allowOwnerFulfillment: true },
  ...
  'muhasebe-smmm': {
    ...
    categoryGroup: 'Finans & Hizmet',
    defaultM2: 50,
    fitoutCostPerM2: 2500,
    legalBasis: '3568 Sayılı SMMM Kanunu & TÜRMOB Yönetmelikleri',
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'SMMM Oda Giriş Harcı & Büro Tescil Belgesi', cost: 45000, description: 'İl SMMM Odası kayıt harçları' },
      { name: 'Şirket/Büro Kuruluş Masrafları', cost: 15000, description: 'Vergi levhası ve noter defter tasdikleri' }
    ],
    equipments: [
      { id: 'archive_system', name: 'Kilitli Mükellef Evrak Arşiv Dolapları', category: 'mandatory', unitCost: 18000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Set', regulatoryNote: 'TÜRMOB mükellef evrak gizliliği standardı.' },
      { id: 'scanner', name: 'Yüksek Hızlı Çift Taraflı Evrak Tarayıcı', category: 'core_tech', unitCost: 19500, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'pc_setup', name: 'Müşavir Bilgisayarı & Çift Ekran', category: 'core_tech', unitCost: 32000, defaultQty: 2, minQty: 1, isLocked: false, unitLabel: 'Adet' }
    ],
    ...
    softwareLicenseCost: { annual: 34000, monthlyMaintenance: 2400, name: 'Bulut Müşavir Muhasebe Paketi & e-İmza Altyapısı (Luca/Zirve)' },
    recommendedStaff: [
  ...
  'hukuk-burosu': {
    ...
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'Baro Levha Tescil & Giriş Harçları', cost: 38000, description: 'İl Barosu büro açılış tescili' },
      { name: 'Büro Vergi Açılış & Noter Giderleri', cost: 14000, description: 'Resmi tasdikler' }
    ],
    equipments: [
      { id: 'archive_steel', name: 'Dava Dosyaları Çelik Arşiv Dolapları', category: 'mandatory', unitCost: 16000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Set', regulatoryNote: 'Baro müvekkil dosya gizliliği şartı.' },
      { id: 'meeting_suite', name: 'Müvekkil Görüşme & Toplantı Takımı', category: 'furniture', unitCost: 28000, defaultQty: 1, minQty: 0, isLocked: false, unitLabel: 'Takım' }
    ],
    initialInventoryCost: 9000,
    initialInventoryDescription: 'Dava dosyası gömlekleri, vekaletname evrakları, kurumsal antetli kağıt ve mühür.',
    softwareLicenseCost: { annual: 15000, monthlyMaintenance: 1100, name: 'UYAP Entegre İcra/Dava & İçtihat Otomasyonu' },
    recommendedStaff: [
  ...
  'yazilim-ajans': {
    ...
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'Şirket Kuruluşu & Marka Tescil Başvurusu', cost: 24000, description: 'Ticaret odası ve TÜRKPATENT başvurusu' }
    ],
    equipments: [
      { id: 'workstations', name: 'Ergonomik Tasarımcı & Geliştirici Masaları', category: 'furniture', unitCost: 12000, defaultQty: 4, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'network_server', name: 'Gigabit Switch & Güvenli Ağ Altyapısı', category: 'core_tech', unitCost: 22000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Set' }
    ],
    initialInventoryCost: 5000,
    initialInventoryDescription: 'Sunucu kabloları, test cihazları ve ofis sarf malzemeleri.',
    softwareLicenseCost: { annual: 42000, monthlyMaintenance: 3500, name: 'Tasarım & Geliştirme Lisans Paketi (Adobe CC, Figma, Jira)' },
    recommendedStaff: [
  ...
  'kafe-kahve': {
    ...
    statutoryCapital: 100000,
    mandatoryLegalItems: [
      { name: 'Tarım İlçe İşletme Kayıt & Hijyen Onayı', cost: 16000, description: 'Gıda satış ve üretim izni' },
      { name: 'İtfaiye Yangın & Baca Uygunluk Raporu', cost: 14000, description: 'Ruhsat denetimi' }
    ],
    equipments: [
      { id: 'hood_system', name: 'Endüstriyel Havalandırma & Davlumbaz', category: 'mandatory', unitCost: 55000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Sistem', regulatoryNote: 'İtfaiye ve belediye hijyen şartı.' },
      { id: 'espresso_machine', name: '2 Gruplu Profesyonel Espresso Makinesi', category: 'core_tech', unitCost: 125000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'grinder', name: 'On-Demand Espresso & Filtre Değirmeni', category: 'core_tech', unitCost: 32000, defaultQty: 2, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'ice_maker', name: 'Sanayi Tipi Buz Makinesi (Günde 30kg)', category: 'appliances', unitCost: 36000, defaultQty: 1, minQty: 0, isLocked: false, unitLabel: 'Adet' },
      { id: 'cafe_furniture', name: 'Masa & Sandalye Seti (4 Kişilik Ahşap/Metal)', category: 'furniture', unitCost: 9500, defaultQty: 8, minQty: 1, isLocked: false, unitLabel: 'Takım', scalesWithM2: true, m2Ratio: 10 }
    ],
    ...
    softwareLicenseCost: { annual: 16000, monthlyMaintenance: 1200, name: 'Restoran Bulut POS & QR Menü Adisyon Otomasyonu' },
    recommendedStaff: [
  ...
  'restoran-lokanta': {
    ...
    mandatoryLegalItems: [
      { name: 'Sulu Filtreli Baca & Çatı Çıkış Onayı', cost: 45000, description: 'Belediye çevre müdürlüğü baca projesi' },
      { name: 'Gıda Sicil & İşyeri Açma Harcı', cost: 22000, description: 'Ruhsatlandırma' }
    ],
    equipments: [
      { id: 'water_hood', name: 'Sulu Sistem Endüstriyel Davlumbaz & Karbon Filtre', category: 'mandatory', unitCost: 95000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Sistem', regulatoryNote: 'İtfaiye ve çevre duman tahliye şartı.' },
      { id: 'cooker_4', name: '4 Gözlü Sanayi Tipi Kuzine & Gazlı Ocak', category: 'machinery', unitCost: 65000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Set' },
      { id: 'deep_freeze', name: 'Sanayi Tipi Dik Soğutucu & Derin Dondurucu', category: 'appliances', unitCost: 52000, defaultQty: 2, minQty: 1, isLocked: false, unitLabel: 'Adet' }
    ],
    initialInventoryCost: 120000,
    initialInventoryDescription: 'Karkas et, sıvı yağ, bakliyat, un, sebze, baharat, meşrubat ve paket servis ambalaj stoku.',
    softwareLicenseCost: { annual: 24000, monthlyMaintenance: 1900, name: 'Mutfak KDS Ekranı & Garson El Terminali Restoran ERP' },
    recommendedStaff: [
  ...
  'donerci-kebapci': {
    ...
    statutoryCapital: 100000,
    mandatoryLegalItems: [
      { name: 'Müstakil Baca Çatı Tahliye Uygunluğu', cost: 38000, description: 'Duman tahliye proje izni' },
      { name: 'Belediye Ruhsat & Hijyen Harçları', cost: 18000, description: 'İşyeri ruhsatı' }
    ],
    equipments: [
      { id: 'doner_burner', name: '4 Radyanlı Motorlu Döner Ocağı & Robot Bıçak', category: 'machinery', unitCost: 48000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'salad_bar', name: 'Soğutmalı Salata Barı & Meze Dolabı', category: 'appliances', unitCost: 32000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' }
    ],
    ...
    softwareLicenseCost: { annual: 14000, monthlyMaintenance: 1100, name: 'Paket Servis & Hızlı Sipariş POS Otomasyonu' },
    recommendedStaff: [
      { role: 'Döner Ustası', count: 1, avgSalary: 48000, isMandatory: true, allowOwnerFulfillment: true },
  ...
  'cigkofte-subesi': {
    ...
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'Gıda Satış Sicil & Belediye Harçları', cost: 12000, description: 'İşletme tescil onayı' }
    ],
    equipments: [
      { id: 'cigkofte_counter', name: 'Camlı & Soğutmalı Çiğköfte Sunum Tezgahı', category: 'appliances', unitCost: 34000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'fire_ext', name: 'Yangın Söndürme Tüpü (6kg)', category: 'mandatory', unitCost: 3500, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: 'Yangın Yönetmeliği Md. 99.' }
    ],
    ...
    softwareLicenseCost: { annual: 8500, monthlyMaintenance: 700, name: 'Hızlı Paketleme & Barkodlu POS Terminali' },
    recommendedStaff: [
  ...
  'firin-unlu-mamuller': {
    ...
    mandatoryLegalItems: [
      { name: 'Kapasite Raporu & Sanayi Elektriği Proje İzni', cost: 42000, description: 'Sanayi İl Müdürlüğü tescili' },
      { name: 'Gıda Üretim İzin Harçları', cost: 24000, description: 'Tarım Bakanlığı kayıt' }
    ],
    equipments: [
      { id: 'deck_oven', name: 'Katlı Taş Tabanlı / Döner Arabalı Ekmek Fırını', category: 'machinery', unitCost: 185000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'mixer', name: 'Spiral Hamur Yoğurma Kazanı (50kg)', category: 'machinery', unitCost: 55000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'heated_counter', name: 'Isıtmalı Camlı Börek & Poğaça Teşhir Tezgahı', category: 'furniture', unitCost: 42000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' }
    ],
    initialInventoryCost: 90000,
    initialInventoryDescription: 'Un çuvalları, maya, susam, yağ, şeker, peynir, kıyma ve fırın ambalaj stoku.',
    softwareLicenseCost: { annual: 12000, monthlyMaintenance: 900, name: 'Terazi Entegre Hızlı Kasa & Üretim Takip Yazılımı' },
    recommendedStaff: [
  ...
  'eczane-medikal': {
    ...
    mandatoryLegalItems: [
      { name: 'Sağlık Bakanlığı Eczane Açılış Ruhsatı', cost: 45000, description: 'İl Sağlık Müdürlüğü uygunluk harcı' },
      { name: 'Eczacı Odası Kayıt & Tescil Bedeli', cost: 24000, description: 'Resmi oda tescili' }
    ],
    equipments: [
      { id: 'pharma_fridge', name: 'Dijital Dereceli İlaç Buzdolabı (2-8°C)', category: 'mandatory', unitCost: 48000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: 'Bakanlık soğuk zincir aşı ve ilaç saklama standardı.' },
      { id: 'safe_red', name: 'Kilitli Çelik Kırmızı & Yeşil Reçete Kasası', category: 'mandatory', unitCost: 18000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: 'Uyuşturucu ve psikotrop ilaçlar kilitli kasada tutulmalıdır.' },
      { id: 'lab_set', name: 'Majistral Laboratuvar Tezgahı & Su Arıtma Kiti', category: 'mandatory', unitCost: 35000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Set', regulatoryNote: 'Majistral ilaç hazırlama alanı yasal zorunludur.' },
      { id: 'pharma_drawers', name: 'Kademeli İlaç Çekmeceleri & Cam Teşhir Dolapları', category: 'furniture', unitCost: 110000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Sistem' }
    ],
    initialInventoryCost: 550000,
    ...
    softwareLicenseCost: { annual: 24000, monthlyMaintenance: 1800, name: 'TEB Medula & İTS İlaç Takip Sistemi Otomasyonu' },
    recommendedStaff: [
      { role: 'Mesul Müdür Eczacı', count: 1, avgSalary: 65000, isMandatory: true, allowOwnerFulfillment: true },
  ...
  'kuafor-guzellik': {
    ...
    statutoryCapital: 100000,
    mandatoryLegalItems: [
      { name: 'Ustalık Belgesi Tescil & Esnaf Odası Harcı', cost: 22000, description: 'Ruhsat şartı' },
      { name: 'Belediye Çevre Hijyen & Açılış İzni', cost: 14000, description: 'Gayrisıhhi müessese harcı' }
    ],
    equipments: [
      { id: 'ventilation', name: 'Özel Kimyasal Koku Tahliye Havalandırması', category: 'mandatory', unitCost: 45000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Sistem', regulatoryNote: 'Kuaför kimyasal buhar tahliye zorunluluğu.' },
      { id: 'autoclave', name: 'B Tipi Otoklav / UV Alet Sterilizatörü', category: 'mandatory', unitCost: 22000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: 'Alet sterilizasyon şartı.' },
      { id: 'hair_stations', name: 'Hidrolik Kuaför Tezgah & Koltuk Takımı', category: 'furniture', unitCost: 21000, defaultQty: 3, minQty: 1, isLocked: false, unitLabel: 'Set', scalesWithM2: true, m2Ratio: 25 },
      { id: 'wash_station', name: 'Seramik Saç Yıkama Koltuğu & Bataryası', category: 'furniture', unitCost: 26000, defaultQty: 2, minQty: 1, isLocked: false, unitLabel: 'Adet' }
    ],
    ...
    softwareLicenseCost: { annual: 11000, monthlyMaintenance: 850, name: 'Salon Randevu, Müşteri Sadakat & SMS CRM Paketi' },
    recommendedStaff: [
  ...
  'dis-klinigi': {
    ...
    mandatoryLegalItems: [
      { name: 'İl Sağlık Müdürlüğü Klinik Ruhsatı & Tescil', cost: 55000, description: 'Sağlık Bakanlığı onay harçları' },
      { name: 'Kurşun Kaplama Radyasyon Güvenlik Raporu (TAEK/TENMAK)', cost: 28000, description: 'Röntgen odası lisansı' }
    ],
    equipments: [
      { id: 'dental_unit', name: 'Entegre Diş Hekimi Koltuk Üniti & Reflektör', category: 'machinery', unitCost: 240000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Set' },
      { id: 'autoclave_med', name: 'B Sınıfı Vakumlu Medikal Otoklav', category: 'mandatory', unitCost: 48000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: 'Tıbbi aletlerin sterilizasyonu için zorunlu cihaz.' },
      { id: 'air_compressor', name: 'Medikal Yağsız ve Sessiz Hava Kompresörü', category: 'mandatory', unitCost: 32000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet' }
    ],
    initialInventoryCost: 140000,
    ...
    softwareLicenseCost: { annual: 22000, monthlyMaintenance: 1600, name: 'Dental Klinik Yönetim & Dijital Hasta Takip Sistemi' },
    recommendedStaff: [
  ...
  'optik-magazasi': {
    ...
    statutoryCapital: 150000,
    mandatoryLegalItems: [
      { name: 'Sağlık Bakanlığı Optisyenlik Müessese Ruhsatı', cost: 35000, description: 'İl Sağlık Müdürlüğü tescili' }
    ],
    equipments: [
      { id: 'lensmeter', name: 'Dijital Odaklama Cihazı (Fokometre)', category: 'mandatory', unitCost: 38000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: '5193 Sayılı Kanun gereği zorunlu cihaz.' },
      { id: 'lens_edger', name: 'Otomatik Cam Kesim & Kanal Açma Makinesi', category: 'machinery', unitCost: 160000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'display_cabinets', name: 'Kilitli & LED Işıklı Gözlük Teşhir Vitrinleri', category: 'furniture', unitCost: 65000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Sistem' }
    ],
    ...
    softwareLicenseCost: { annual: 15000, monthlyMaintenance: 1100, name: 'Optik Medula & ÜTS Ürün Takip Sistemi Yazılımı' },
    recommendedStaff: [
  ...
  'pilates-yoga': {
    ...
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'Gençlik ve Spor İl Müdürlüğü Tesis İzni', cost: 24000, description: 'Antrenörlük belgesi ve tesis uygunluğu' }
    ],
    equipments: [
      { id: 'reformer', name: 'Ahşap Reformer & Cadillac Pilates Aleti', category: 'machinery', unitCost: 42000, defaultQty: 4, minQty: 1, isLocked: false, unitLabel: 'Adet' },
    ...
    softwareLicenseCost: { annual: 9500, monthlyMaintenance: 750, name: 'Üye Takip, Turnike & Online Ders Rezervasyon Yazılımı' },
    recommendedStaff: [
  ...
  'market-bakkal': {
    ...
    statutoryCapital: 100000,
    mandatoryLegalItems: [
      { name: 'TAPDK Belgesi & Belediye İşyeri Ruhsatı', cost: 26000, description: 'Ruhsat ve tütün satış izinleri' }
    ],
    equipments: [
      { id: 'cam_system', name: '8 Kanallı Gece Görüşlü Güvenlik Kamera Kiti', category: 'mandatory', unitCost: 28000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Sistem', regulatoryNote: 'İşyeri güvenlik standardı.' },
      { id: 'dairy_cooler', name: '3 Metre Sütlük & Şarküteri Soğutma Dolabı', category: 'appliances', unitCost: 78000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'shelves', name: 'Duvar ve Orta Market Rafları (Ünite)', category: 'furniture', unitCost: 16000, defaultQty: 8, minQty: 1, isLocked: false, unitLabel: 'Ünite', scalesWithM2: true, m2Ratio: 12 },
      { id: 'pos_scale', name: 'Barkod Okuyucu, Dokunmatik POS & Terazi', category: 'core_tech', unitCost: 32000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Set' }
    ],
    ...
    softwareLicenseCost: { annual: 14000, monthlyMaintenance: 1100, name: 'Market Hızlı Barkod Satış, Terazi & Stok ERP' },
    recommendedStaff: [
  ...
  'butik-giyim': {
    ...
    mandatoryLegalItems: [
      { name: 'Ticaret Sicil & Belediye Açılış Harçları', cost: 18000, description: 'İşyeri tescili' }
    ],
    equipments: [
      { id: 'rfid_gates', name: 'Manyetik Ürün Güvenlik Kapı Antenleri', category: 'mandatory', unitCost: 24000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Set', regulatoryNote: 'Mağaza ürün koruma standardı.' },
      { id: 'hanger_stands', name: 'Işıklı Metal Duvar Askılık & Raf Üniteleri', category: 'furniture', unitCost: 36000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Sistem' },
      { id: 'fitting_room', name: 'Aynalı Prova Kabinleri (Perdeli/Kapılı)', category: 'furniture', unitCost: 14000, defaultQty: 2, minQty: 1, isLocked: false, unitLabel: 'Adet' }
    ],
    ...
    softwareLicenseCost: { annual: 12000, monthlyMaintenance: 950, name: 'Renk / Beden Varyantlı Mağazacılık Barkod Programı' },
    recommendedStaff: [
  ...
  'petshop-urunleri': {
    ...
    statutoryCapital: 75000,
    mandatoryLegalItems: [
      { name: 'İl Tarım Ev ve Süs Hayvanları Satış Ruhsatı', cost: 18000, description: 'Tarım İl Müdürlüğü harçları' }
    ],
    equipments: [
      { id: 'carbon_vent', name: 'Özel Karbon Filtreli Havalandırma Sistemi', category: 'mandatory', unitCost: 32000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Sistem', regulatoryNote: 'İl Tarım koku ve hijyen yönetmeliği şartı.' },
      { id: 'steel_shelves', name: 'Ağır Yük Çelik Mama Rafları', category: 'furniture', unitCost: 14000, defaultQty: 6, minQty: 1, isLocked: false, unitLabel: 'Ünite' }
    ],
    initialInventoryCost: 120000,
    initialInventoryDescription: 'Kedi/köpek mamaları, kumlar, tasmalar, oyuncaklar, ödül mamaları ve bakım ürünleri.',
    softwareLicenseCost: { annual: 9500, monthlyMaintenance: 750, name: 'Petshop Barkod Satış & Son Kullanma Tarihi Takip Yazılımı' },
    recommendedStaff: [
  ...
  'kirtasiye-kitap': {
    ...
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'Oda Kaydı & Belediye Ruhsatı', cost: 14000, description: 'Esnaf tescil harçları' }
    ],
    equipments: [
      { id: 'copier_heavy', name: 'Yüksek Hızlı A3/A4 Çok Fonksiyonlu Dijital Baskı Makinesi', category: 'core_tech', unitCost: 78000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'binding_mach', name: 'Laminasyon & Spiral Ciltleme Makinesi', category: 'appliances', unitCost: 12000, defaultQty: 1, minQty: 0, isLocked: false, unitLabel: 'Set' },
      { id: 'book_racks', name: 'Ahşap & Metal Kitap Teşhir Rafları', category: 'furniture', unitCost: 12500, defaultQty: 6, minQty: 1, isLocked: false, unitLabel: 'Ünite' }
    ],
    ...
    softwareLicenseCost: { annual: 8500, monthlyMaintenance: 650, name: 'Kırtasiye Hızlı Kasa & Fotokopi Sayaç Takip Programı' },
    recommendedStaff: [
  ...
  'cicekci-botanik': {
    ...
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'Belediye İşyeri Açma İzin Harcı', cost: 11000, description: 'Ruhsatlandırma' }
    ],
    equipments: [
      { id: 'flower_fridge', name: 'Camlı Kesme Çiçek Soğutma Dolabı', category: 'appliances', unitCost: 52000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'craft_table', name: 'Buket Tasarım & Paketleme Tezgahı', category: 'furniture', unitCost: 16000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' }
    ],
    ...
    softwareLicenseCost: { annual: 7500, monthlyMaintenance: 600, name: 'Çiçek Sipariş, Web Entegrasyon & Kurye Takip Yazılımı' },
    recommendedStaff: [
  ...
  'telefon-aksesuar': {
    ...
    statutoryCapital: 50000,
    mandatoryLegalItems: [
      { name: 'Ustalık Tescili & Belediye Ruhsatı', cost: 14000, description: 'Teknik servis tescili' }
    ],
    equipments: [
      { id: 'esd_bench', name: 'ESD Antistatik Topraklamalı Çalışma Masası', category: 'mandatory', unitCost: 18000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: 'Statik elektrik koruma standardı.' },
      { id: 'solder_station', name: 'Sıcak Hava Lehim İstasyonu & Mikroskop', category: 'machinery', unitCost: 26000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Set' },
      { id: 'case_stands', name: 'Işıklı Kılıf Duvar Panelleri & Cam Vitrinler', category: 'furniture', unitCost: 32000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Sistem' }
    ],
    ...
    softwareLicenseCost: { annual: 9500, monthlyMaintenance: 750, name: 'Teknik Servis Cihaz Takip, Barkod & SMS Bildirim Yazılımı' },
    recommendedStaff: [
  ...
  'oto-ekspertiz': {
    ...
    statutoryCapital: 200000,
    mandatoryLegalItems: [
      { name: 'TSE Hizmet Yeterlilik Belgesi Harcı & Kalibrasyon', cost: 58000, description: 'TSE HYB resmi tescili' },
      { name: 'Belediye Gayrisıhhi Müessese Ruhsatı', cost: 22000, description: 'İşyeri açma harcı' }
    ],
    equipments: [
      { id: 'dyno_test', name: '4x4 Dinamometre Motor Gücü Test Cihazı', category: 'machinery', unitCost: 320000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Hat' },
      { id: 'brake_test', name: 'Fren Test, Süspansiyon & Yanal Kayma Parkuru', category: 'machinery', unitCost: 240000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Hat' },
      { id: 'exhaust_vent', name: 'Egzoz Gazı Tahliye & Havalandırma Sistemi', category: 'mandatory', unitCost: 45000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Sistem', regulatoryNote: 'TSE 13805 zorunlu havalandırma standardı.' },
      { id: 'paint_meter', name: 'Dijital Boya Kalınlık Ölçüm Cihazı (2 Adet)', category: 'core_tech', unitCost: 14000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Set' }
    ],
    ...
    softwareLicenseCost: { annual: 32000, monthlyMaintenance: 2600, name: 'TSE & Noter Entegre Bulut Oto Ekspertiz Raporlama Yazılımı' },
    recommendedStaff: [
  ...
  'oto-yikama': {
    ...
    statutoryCapital: 100000,
    mandatoryLegalItems: [
      { name: 'Atık Su Deşarj İzni & İSKİ Kanal Bağlantı Onayı', cost: 48000, description: 'Çevre arıtma izni' },
      { name: 'Ruhsat Harçları', cost: 16000, description: 'Oto yıkama ruhsatı' }
    ],
    equipments: [
      { id: 'sand_trap', name: 'Yağ ve Çamur Tutucu Ön Arıtma Havuz Izgarası', category: 'mandatory', unitCost: 38000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Sistem', regulatoryNote: 'Çevre ve atık su deşarj mevzuatı şartı.' },
      { id: 'wash_pump', name: '200 Bar Sıcak/Soğuk Basınçlı Yıkama Makinesi', category: 'machinery', unitCost: 42000, defaultQty: 2, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'foam_tank', name: 'Paslanmaz Köpük Tankı (60L) & Kompresör', category: 'appliances', unitCost: 28000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Set' },
      { id: 'vac_cleaner', name: '3 Motorlu Islak-Kuru Sanayi Tipi Süpürge', category: 'appliances', unitCost: 16000, defaultQty: 2, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'polisher_set', name: 'Detailing Pasta-Cila & Seramik Kaplama Seti', category: 'machinery', unitCost: 22000, defaultQty: 1, minQty: 0, isLocked: false, unitLabel: 'Set' }
    ],
    initialInventoryCost: 35000,
    ...
    softwareLicenseCost: { annual: 8500, monthlyMaintenance: 650, name: 'Oto Yıkama Hızlı Fiş, Randevu & Abone Takip Yazılımı' },
    recommendedStaff: [
  ...
  'lastik-servisi': {
    ...
    statutoryCapital: 100000,
    mandatoryLegalItems: [
      { name: 'Ustalık Tescil & Atık Depolama Ruhsatı', cost: 22000, description: 'Ruhsat harçları' }
    ],
    equipments: [
      { id: 'tire_changer', name: 'Pnömatik Otomatik Lastik Sökme-Takma Makinesi', category: 'machinery', unitCost: 75000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'balancer', name: 'Dijital Ekranlı Lastik Balans Makinesi', category: 'machinery', unitCost: 58000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'air_compressor_500', name: '500 Litre Sanayi Tipi Pistonlu Hava Kompresörü', category: 'mandatory', unitCost: 45000, defaultQty: 1, minQty: 1, isLocked: true, unitLabel: 'Adet', regulatoryNote: 'Pnömatik servis güvenlik standardı.' }
    ],
    initialInventoryCost: 140000,
    initialInventoryDescription: 'Yazlık/kışlık sıfır lastikler, siboplar, kurşun balans ağırlıkları, yama ve fitil tamir kitleri.',
    softwareLicenseCost: { annual: 9500, monthlyMaintenance: 750, name: 'Lastik Oteli, Barkod & Hızlı Servis Takip Programı' },
    recommendedStaff: [
  ...
  'kuru-temizleme': {
    ...
    statutoryCapital: 100000,
    mandatoryLegalItems: [
      { name: 'Buhar Kazanı & Emisyon Uygunluk İzni', cost: 26000, description: 'Belediye çevre ruhsatı' }
    ],
    equipments: [
      { id: 'dry_clean_machine', name: 'Kapalı Devre Çevre Dostu Kuru Temizleme Makinesi', category: 'machinery', unitCost: 260000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'steam_iron', name: 'Vakumlu ve Üflemeli Buharlı Paskala Ütü Tezgahı', category: 'appliances', unitCost: 42000, defaultQty: 1, minQty: 1, isLocked: false, unitLabel: 'Adet' },
      { id: 'conveyor', name: 'Otomatik Motorlu Elbise Askı Konveyörü', category: 'furniture', unitCost: 38000, defaultQty: 1, minQty: 0, isLocked: false, unitLabel: 'Adet' }
    ],
    initialInventoryCost: 40000,
    initialInventoryDescription: 'Perkloretilen / hidrokarbon solventler, leke çıkarıcı kimyasallar, elbise poşetleri ve askılar.',
    softwareLicenseCost: { annual: 9500, monthlyMaintenance: 750, name: 'Kuru Temizleme Parça Takip, Barkod & SMS Otomasyonu' },
    recommendedStaff: [
...
export const SMART_EQUIPMENT_DICTIONARY: SmartEquipmentPreset[] = [
  ...
  // Koltuklar
  { keywords: ['koltuk', 'berjer', 'dinlenme', 'bekleme'], name: 'Müşteri Bekleme Lounge Koltuk Grubu (İkili + Tekli)', category: 'furniture', suggestedUnitCost: 16000, unitLabel: 'Takım', description: 'Misafirler için konforlu bekleme koltuğu seti.' },
  ...
  { keywords: ['klima', 'inverter', 'soğutma', 'ısıtma'], name: 'İnverter Split Klima (18.000 BTU A+++)', category: 'appliances', suggestedUnitCost: 28000, unitLabel: 'Adet', description: 'Enerji tasarruflu sessiz mekan iklimlendirme.' },
  { keywords: ['klima', 'salon', 'büyük'], name: 'Salon Tipi Ayaklı Ticari Klima (24.000 BTU)', category: 'appliances', suggestedUnitCost: 36000, unitLabel: 'Adet', description: 'Geniş ticari mekanlar için yüksek debili klima.' },
  { keywords: ['hava perdesi', 'kapı', 'perde'], name: 'Otomatik Giriş Kapısı Hava Perdesi (120 cm)', category: 'appliances', suggestedUnitCost: 14000, unitLabel: 'Adet', description: 'Giriş kapısından toz, koku ve ısı kaybını önleyen hava akımı.' },

  // Çay & Kahve & İkram
  { keywords: ['kahve', 'çay', 'ikram', 'otomat'], name: 'Otomatik Çay & Kahve İkram Makinesi', category: 'appliances', suggestedUnitCost: 8500, unitLabel: 'Adet', description: 'Müşteriler için taze çekirdekten kahve ve çay otomatı.' },
  { keywords: ['su', 'sebil', 'arıtma'], name: 'Arıtmalı Sıcak-Soğuk Su Sebili', category: 'appliances', suggestedUnitCost: 6500, unitLabel: 'Adet', description: 'Şebekeye bağlı filtreli sıcak/soğuk su makinesi.' },
  ...
  // Sağlık, Tartı & Baskül
  { keywords: ['tartı', 'baskül', 'boy', 'kilo', 'tansiyon'], name: 'Boy-Kilo Ölçerli Dijital Eczane Tartısı & Tansiyon Kiti', category: 'core_tech', suggestedUnitCost: 18500, unitLabel: 'Set', description: 'Müşteriler için boy, kilo, yağ oranı ve tansiyon ölçüm istasyonu.' },
  ...
  // Ses & Görüntü
  { keywords: ['ses', 'müzik', 'hoparlör'], name: 'Bluetooth & Tavan Tipi Mağaza / Kafe Ambiyans Ses Sistemi', category: 'core_tech', suggestedUnitCost: 12500, unitLabel: 'Set', description: 'Mekan geneline homojen müzik yayını sağlayan tavan hoparlörleri ve amfi.' },
  { keywords: ['tv', 'televizyon', 'ekran', 'akıllı'], name: '55 inç 4K UHD Akıllı Bilgilendirme TV & Askı Aparatı', category: 'core_tech', suggestedUnitCost: 18500, unitLabel: 'Adet', description: 'Müşteri bekleme alanı için akıllı televizyon.' },
