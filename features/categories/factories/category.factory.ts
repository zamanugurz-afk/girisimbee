...
export const SEED_CATEGORIES: CreateCategoryInput[] = [
  ...
  { slug: 'ortak-bul', name: 'Ortak Arıyorum', accentColor: '#6366F1', icon: 'Handshake', sortOrder: 3 },
  ...
  { slug: 'isletme-devri', name: 'İşletme Devri', accentColor: '#D97706', icon: 'Building2', sortOrder: 8 },
  { slug: 'genel-ilan', name: 'Genel İlan', accentColor: '#0EA5E9', icon: 'Megaphone', sortOrder: 9 },
];
