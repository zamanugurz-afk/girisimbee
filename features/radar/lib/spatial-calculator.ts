...
export const TURKEY_PROVINCE_TOP_50_TRADES: SectorPopularityMeta[] = [
  ...
  },
  {
    ...
    upperSesAffinity: 1.6,
    standardSesAffinity: 1.1,
    upperSesReason: 'Bölgedeki modern plazalarda prestijli genel müdürlük, bölge ofisi ve kurumsal çalışma alanları.',
    standardSesReason: 'Bölgedeki ticari işletmeler ve KOBİ merkezleri için ofis ve idari operasyon merkezi.',
  },
  {
    key: 'medical_clinic',
    ...
    upperSesAffinity: 1.9,
    standardSesAffinity: 1.2,
    upperSesReason: 'Uzman hekim muayenehaneleri, estetik plastik cerrahi, dermatoloji ve butik tıp merkezi açığı.',
    standardSesReason: 'Mahalle sakinleri için erişilebilir uzman doktor muayenehaneleri ve poliklinik hizmetleri.',
  },
  {
    ...
    upperSesAffinity: 1.7,
    standardSesAffinity: 1.05,
    upperSesReason: 'Yönetim danışmanlığı, insan kaynakları, denetim, vergi ve expat çözümleri ofisi.',
    standardSesReason: 'Yerel işletmelere yönelik teşvik, hibe ve kurumsal danışmanlık hizmetleri.',
  },
  {
    key: 'oto_tamir',
    ...
    upperSesAffinity: 1.1,
    standardSesAffinity: 1.3,
    upperSesReason: 'Özel araç servisleri, periyodik bakım ve diagnostik arıza tespit merkezi.',
    standardSesReason: 'Mekanik tamirhane, motor ustası, fren-balata ve oto elektrik bakım noktası.',
  },
  {
    ...
    upperSesAffinity: 1.2,
    standardSesAffinity: 1.1,
    upperSesReason: 'Bölgedeki bağımsız mağazalar, butik showroomlar ve ticari faaliyet merkezleri.',
    standardSesReason: 'Mahalle ölçeğinde muhtelif ticari dükkanlar, servis noktaları ve yerel perakende.',
  },
];
