...
function basePayload(values: ListingFormValues) {
  ...
  return {
    ...
    city: core.city ?? null,
    companyId: readString(customFields.companyId) || null,
    companyName: readString(customFields.companyName) || null,
    companySlug: readString(customFields.companySlug) || null,
    businessName: readString(customFields.businessName) || null,
