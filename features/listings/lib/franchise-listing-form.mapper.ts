...
export function listingFormValuesToFranchiseGivePayload(
  ...
  return {
    ...
    city: primaryCity,
    contactPhone: readString(customFields.contactPhone) || values.contactPhone?.trim() || readString(customFields.phone) || null,
    contactName: readString(customFields.contactName) || readString(customFields.fullName) || readString(customFields.authorizedPerson) || null,
