...
export const LISTING_CATEGORY_THEMES: Record<string, ListingCategoryTheme> = {
  ...
  [CATEGORY_IDS.ortakBul]: {
    ...
    cardGlow: 'shadow-[0_4px_24px_-4px_rgba(99,102,241,0.15)]',
    headerBorder: 'border-indigo-100 dark:border-indigo-900/60',
    footerBorder: 'border-indigo-100 dark:border-indigo-900/60',
    stepperActiveBorder: 'border-indigo-600 dark:border-indigo-400',
    ...
    stepperActiveNumberBg: 'bg-indigo-600 text-white shadow-2xs',
    stepperActiveNumberText: 'text-white',
    stepBadgeBg: 'bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300',
    stepBadgeText: 'text-indigo-700 dark:text-indigo-300',
    categoryLabelText: 'text-indigo-700 dark:text-indigo-300',
    ...
    ctaButtonBg: 'bg-indigo-600 hover:bg-indigo-700 text-white font-semibold',
    progressBarBg: 'bg-indigo-600',
    progressText: 'text-indigo-700 dark:text-indigo-300',
    progressActiveBg: 'bg-indigo-500/20 text-indigo-700 dark:text-indigo-300',
    progressActiveDot: 'bg-indigo-600',
    previewBadge: 'bg-indigo-500/10 text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-300',
    previewTagText: 'text-indigo-600 dark:text-indigo-400',
  },
  ...
  [CATEGORY_IDS.isletmeDevri]: {
    ...
    cardGlow: 'shadow-[0_4px_24px_-4px_rgba(217,119,6,0.12)]',
