  ...
  [CATEGORY_IDS.bayilikAl]: withConsolidatedPublishFlow(
    {
      ...
      description: 'Marka adı, kuruluş yılı, konsept türü ve ana sektör',
      coreFields: ['title', 'shortDescription'],
      customFieldKeys: [
        'companyName',
        'establishmentYear',
    ...
    {
      id: 'financials',
      title: 'Yatırım ve Finansal Koşullar',
      description: 'Toplam yatırım, isim hakkı, ciro payı ve sunulan destekler',
      customFieldKeys: [
        'totalInvestment',
        'franchiseFee',
        'profitMargin',
    ...
    {
      id: 'details',
      title: 'Lokasyon ve Hukuki Şartlar',
      description: 'Marka tescili, sözleşme şartları, mağaza tipi ve detaylı açıklama',
      coreFields: ['longDescription'],
      customFieldKeys: [
        'trademarkStatus',
        'contractProvided',
