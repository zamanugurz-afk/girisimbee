  ...
  [CATEGORY_IDS.yatirimBul]: withPublishFlow(
    {
      ...
      description: 'Girişim adı, sektör, aşama ve konum — kartın ilk bakışta görünen bilgileri',
      coreFields: ['title', 'city'],
      customFieldKeys: ['sector', 'stage', 'productStatus', 'productName', 'foundedYear'],
    },
    {
      id: 'product-market',
      title: 'Ürün ve pazar',
      description: 'İş modeli, hedef müşteri ve kısa problem / çözüm / fark',
      customFieldKeys: [
        'businessModel',
        'targetCustomer',
        'problem',
    ...
    },
    {
      id: 'traction',
      title: 'Traction',
      description: 'Gelir ve müşteri durumu. Rakam yoksa boş bırakın — uydurmayın',
      customFieldKeys: [
        'revenueStatus',
        'tractionStatus',
        'monthlyRevenue',
    ...
    {
      id: 'funding',
      title: 'Yatırım ihtiyacı',
      description: 'Aranan tutar, hisse ve yatırımın kullanılacağı alanlar',
      customFieldKeys: [
        'investmentAmount',
    ...
    },
    {
      ...
      description:
        'Ekip bilgisi ve yatırımcıya özet. Taslak yapılandırılmış veriden üretilir; AI isteğe bağlıdır.',
