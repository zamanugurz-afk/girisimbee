...
export const BROWSE_CATEGORY_MAP: Record<string, BrowseCategoryEntry> = {
  ...
  'isletme-devri': {
    slug: 'isletme-devri',
    label: 'İşletme Devri',
    listingTypeSlug: 'isletme-devret',
    appCategoryId: CATEGORY_IDS.isletmeDevri,
    appListingTypeId: LISTING_TYPE_IDS.businessTransferSellDefault,
    dbCategoryId: CATEGORY_IDS.isletmeDevri,
    dbListingTypeId: LISTING_TYPE_IDS.businessTransferSellDefault,
    filterListingTypeIds: [
  ...
  hizmetler: {
    ...
    dbCategoryId: CATEGORY_IDS.hizmetler,
    dbListingTypeId: LISTING_TYPE_IDS.hizmetVeriyorumDefault,
    filterListingTypeIds: [LISTING_TYPE_IDS.hizmetVeriyorumDefault],
  },
  'genel-ilan': {
    slug: 'genel-ilan',
    label: 'Genel İlanlar',
...
export const BROWSE_CATEGORY_SLUG_ALIASES: Record<string, string> = {
  ...
  devret: 'isletme-devri',
  devral: 'isletme-devri',
  'business-transfer': 'isletme-devri',
  hizmet: 'hizmetler',
  'hizmet-ver': 'hizmetler',
  esnaf: 'hizmetler',
  'esnaf-ve-hizmetler': 'hizmetler',
  usta: 'hizmetler',
  general: 'genel-ilan',
  ilan: 'genel-ilan',
...
const APP_CATEGORY_ID_TO_DB: Record<string, CategoryId> = {
  ...
  [CATEGORY_IDS.isletmeDevri]: MARKETPLACE_CATEGORY_IDS.ortaklik,
  [CATEGORY_IDS.hizmetler]: CATEGORY_IDS.hizmetler,
  ...
  [MARKETPLACE_CATEGORY_IDS.isletmeDevri]: MARKETPLACE_CATEGORY_IDS.ortaklik,
};
...
const APP_LISTING_TYPE_ID_TO_DB: Record<string, ListingTypeId> = {
  ...
  [LISTING_TYPE_IDS.businessTransferSellDefault]: MARKETPLACE_LISTING_TYPE_IDS.ortakAriyorum,
  [LISTING_TYPE_IDS.businessTransferBuyDefault]: MARKETPLACE_LISTING_TYPE_IDS.ortakAriyorum,
  [LISTING_TYPE_IDS.hizmetVeriyorumDefault]: LISTING_TYPE_IDS.hizmetVeriyorumDefault,
  ['lt000001-0001-4000-8000-000000000009' as ListingTypeId]: MARKETPLACE_LISTING_TYPE_IDS.ortakAriyorum,
  ['lt000001-0001-4000-8000-000000000010' as ListingTypeId]: MARKETPLACE_LISTING_TYPE_IDS.ortakAriyorum,
