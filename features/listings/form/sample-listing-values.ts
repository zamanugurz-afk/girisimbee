    ...
    case CATEGORY_IDS.isBul: {
      ...
      return {
        ...
        customFields: {
          ...
          workType: 'Tam zamanlı',
          professionalSkills:
            'Müşteri odaklı ürün geliştirme, takım içi iletişim, kod incelemesi ve sprint planlama deneyimim var.',
          technicalSkills: 'TypeScript, React, Node.js, PostgreSQL, Git',
          ...
          experiences: [
            {
              ...
              duration: '3 yıl · 2021–2024',
              responsibilities:
                'Ürün özelliklerini uçtan uca geliştirdim; API tasarımı, frontend arayüzleri ve kod incelemesi yaptım.',
              achievements: 'Yayına aldığımız özelliklerle dönüşüm oranını artırdık.',
            },
          ],
        },
      };
