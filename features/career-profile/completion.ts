...
export function valuesFromCareerSource(source: CareerFieldSource): CareerProfileFormValues {
  ...
  return {
    ...
    phone: typeof cf.phone === 'string' ? cf.phone : '',
    linkedin: typeof cf.linkedin === 'string' ? cf.linkedin : '',
    website: typeof cf.website === 'string' ? cf.website : '',
    nationality: typeof cf.nationality === 'string' ? cf.nationality : '',
    address: typeof cf.address === 'string' ? cf.address : '',
