...
const ROOT = join(process.cwd(), 'features', 'partnership-matching');
...
describe('partnership matching isolation', () => {
  it('does not import career matching, career profile, or /is routes', () => {
