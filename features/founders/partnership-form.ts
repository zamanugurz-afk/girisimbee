...
const SEEKING_FIELDS: ListingFieldSchema['fields'] = [
  ...
  {
    key: 'partnershipTypesOther',
    label: 'Özel Ortaklık Modeli',
    type: 'string',
    required: false,
  },
  {
...
const JOINING_FIELDS: ListingFieldSchema['fields'] = [
  ...
  {
    key: 'partnershipTypes',
    label: 'Sunduğum ortaklık modelleri ve rolleri',
    type: 'multi-enum',
    required: false,
    options: [...ALL_PARTNERSHIP_TYPES],
  },
  ...
  {
    key: 'professionalSkills',
    label: 'Sunduğum mesleki ve yönetsel yetkinlikler',
    type: 'multi-enum',
    required: false,
  },
  {
  ...
  {
    key: 'technicalSkills',
    label: 'Sunduğum teknik ve sektörel uzmanlıklar',
    type: 'multi-enum',
    required: false,
  },
  {
  ...
  {
    key: 'tools',
    label: 'Kullandığım araçlar, teknolojiler ve ekipmanlar',
    type: 'multi-enum',
    required: false,
  },
  {
