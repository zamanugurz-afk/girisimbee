...
export const MOCK_MARKET_ITEMS: MarketItem[] = [
  {
    ...
    description:
      'Tüm kredi kartlarından tek tıkla ödeme alın, ertesi gün hesabınıza geçsin. Girişimbee üyelerine özel indirimli komisyon avantajı ve ücretsiz sanal POS kurulumu.',
    imageUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=800&h=500&fit=crop&q=80',
    linkUrl: '/market/market-ad-1',
  ...
  },
  {
    ...
    description:
      'Ölçeklenebilir sunucu, GPU altyapısı ve teknik mimari mentorluğu ile girişiminizi AWS üzerinde hızla büyütün. Girişimbee Activate Partner ayrıcalığı.',
    imageUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&h=500&fit=crop&q=80',
    linkUrl: '/market/market-ad-2',
  ...
  },
  {
    ...
    description:
      'Yüksek bütçeli Meta ve Google Ads kampanyalarınızı ROAS odaklı yönetin. Kurumsal performans pazarlama, kreatif video üretimi ve büyüme ortaklığı.',
    imageUrl: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=500&fit=crop&q=80',
    linkUrl: '/market/market-ad-3',
  ...
  },
  {
    ...
    description:
      'Girişimler için standart SAFE, Gizlilik (NDA), İş Ortaklığı ve Hissedarlar sözleşmelerini avukat onaylı şablonlarla dakikalar içinde hazırlayın.',
    imageUrl: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?w=800&h=500&fit=crop&q=80',
    linkUrl: '/market/market-ad-4',
