...
/**
 * Account panel shell — sidebar + content.
 * Server Component wrapper; sidebar is a client island for active route state.
 */
export function AccountPanelLayout({ children }: { children: ReactNode }) {
  return (
