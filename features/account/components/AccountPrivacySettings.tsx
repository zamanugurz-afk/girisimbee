...
export function AccountPrivacySettings({
  ...
  return (
    <section
      id="gizlilik"
      className="rounded-2xl border border-border/80 bg-background p-5 dark:border-white/10 sm:p-6"
    >
...
function ToggleRow({
  ...
  return (
    <div className="flex items-start justify-between gap-4 rounded-2xl border border-border/70 p-4 dark:border-white/10">
