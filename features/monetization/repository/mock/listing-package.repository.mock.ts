...
const CATALOG: ListingPackageCatalogItem[] = [
  ...
  { id: ids.listingPackage('00000000-0000-4000-8000-000000000011'), slug: 'hizli_erisim', name: 'Süper İlan Paketi', description: 'Keşfet ve aramalarda en üst sırada 30 gün gösterim', priceCents: 9900, credits: null, durationDays: 30, sortOrder: 11, status: 'active', packageKind: 'homepage_placement', featuredListing: false, urgentListing: true, createdAt: now(), updatedAt: now() },
];
