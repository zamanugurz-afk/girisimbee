...
const CATALOG: ListingPackageCatalogItem[] = [
  ...
  { id: ids.listingPackage('00000000-0000-4000-8000-000000000010'), slug: 'vitrin', name: 'Vitrin Paketi', description: 'Ana sayfa Öne Çıkan İlanlar bölümünde 30 gün gösterim', priceCents: 9900, credits: null, durationDays: 30, sortOrder: 10, status: 'active', packageKind: 'homepage_placement', featuredListing: true, urgentListing: false, createdAt: now(), updatedAt: now() },
  { id: ids.listingPackage('00000000-0000-4000-8000-000000000011'), slug: 'hizli_erisim', name: 'Acil Vitrin Paketi', description: 'Ana sayfa Acil İlanlar bölümünde 30 gün gösterim', priceCents: 9900, credits: null, durationDays: 30, sortOrder: 11, status: 'active', packageKind: 'homepage_placement', featuredListing: false, urgentListing: true, createdAt: now(), updatedAt: now() },
];
